...
export function RecruitmentPanel({ roleTitle }: { roleTitle: string }) {
  ...
  return (
    <aside className="direct-contact-panel" aria-labelledby="application-email-title">
      ...
      <a className="button" href={applicationHref}><Mail size={18} /> Email your application</a>
      <p className="direct-contact-note">This website does not upload, collect or store application details.</p>
    </aside>
  );
}
